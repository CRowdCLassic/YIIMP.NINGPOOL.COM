...
# Current Author: NINGPOOL
#QQ群：138624730
# Web: yiimp.ningpool.com    
#搭建矿池，主流币矿池费用2K,山寨币矿池费用3K.另外接各种大算力老板的单子，我提供矿池，老板提供钱包rpc,费用协商.
...
displayErr() {
    ...
    read -e -p "Enter your Public IP for admin access (http://yiimp.ningpool.com/) : " Public
...
define('"'"'YAAMP_BTCADDRESS'"'"', '"'"'13TVbB6tZcnKx8sQhifLj6MQMJSvwHspah'"'"');
